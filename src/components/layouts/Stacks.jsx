...
const Stacks = () => {
  return (
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8 relative group">
      <div className="h-16 aspect-square lg:w-56 bg-linear-to-r from-white dark:from-neutral-900 absolute left-0 z-10" />
      <div className="h-16 aspect-square lg:w-56 bg-linear-to-l from-white dark:from-neutral-900 absolute right-0 z-10" />
